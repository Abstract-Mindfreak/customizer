...
export function applyVariantPreset(variant) {
    ...
    switch(variant) {
        case '023-the-bomblet':
            // Полусферы - Алюминий
            setState('spheres', { variant: '2', color: null, colorValue: '#a1a1a0' });
            selectVariant('spheres', '2');

            // Корпус - Алюминий
            setState('body', { variant: '2', color: null, colorValue: '#a1a1a0' });
            selectVariant('body', '2');

            // Тип логотипа Серебристый
        ...
        case 'malfa':
            ...
            // Корпус - Черный
            setState('body', { variant: '3', color: null, colorValue: '#000000' });
        ...
        case '017-fet':
            // Полусферы - Стареющая латунь
            setState('spheres', { variant: '1', color: null, colorValue: '#d4af37' });
            selectVariant('spheres', '1');

            // Корпус - Кремовый
            setState('body', { variant: '1', color: 'RAL 1013', colorValue: '#dfdbc7' });
