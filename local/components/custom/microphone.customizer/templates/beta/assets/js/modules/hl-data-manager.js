...
function initializeModelOptions(modelOptions, modelCode) {
    ...
    Object.keys(modelOptions).forEach(viewType => {
        ...
        } else if (value.includes('satinsteel') || value.includes('satin-steel')) {
            // Специальная обработка для сатинированной стали
            hex = '#C0C0C0'; // Серебристый цвет для сатинированной стали
            variant = '3'; // Вариант 3 для сатинированной стали
            //для бесплатных brass и 9005 установим hex и variant
            
        } else if (value.includes('9005')) {
            hex = '#111111'; // Черный цвет для Матовый черный
            variant = '1'; // Вариант 1 для Матовый черный
        } else if (value.includes('brass')) {
            hex = '#CD7F32'; // Коричневый цвет для brass
            variant = '2'; // Вариант 2 для brass (Классическая латунь)
        }
